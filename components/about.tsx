...
export default function About() {
  return (
    <motion.section
      className="mb-28 max-w-[45rem] text-center leading-8 sm:md-40"
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">QA engineer</span> on great
        project full of skillful people. I learnt so much, especially about
        testing. After 4 years of experience with tools like Micro Focus UFT,
        ALM, Postman, SoapUI, and most of all with{" "}
        <span className="italic">Cypress</span>
        , I decided to move on. Currently I am happily working on same position, but in different setting
