...
export default function Project({
  ...
  return (
    ...
    >
      <section className="relative bg-red-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 sm:h-[20rem] group-even:pl-8 hover:bg-red-200 transition">
